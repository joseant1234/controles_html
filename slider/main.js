...
class Slider{
    constructor(selector, movimiento = true){
      ...
      // querySelectorAll permite realizar la bùsqueda en los hijos del elemento (slider)
      // se solicta que busque tambien elementos dentro de la clase container
      // > indica hijos directos (los primeros hijos)
      // * indica todos elemetos. Con .container > * indica todos los hios directos de la clase container.
    ...
    bindEvents(){
      this.slider.querySelectorAll(".controls li")
          .forEach(item =>{
            // al utilizar un listener se envia un evento con lo q sucediio
    ...
    move(){
      // this -> Algo diferente sino se pone en el constructor this.move.bind(this)
      this.contador ++;
